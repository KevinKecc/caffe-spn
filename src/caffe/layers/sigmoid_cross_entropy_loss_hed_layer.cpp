...
#include "caffe/layers/sigmoid_cross_entropy_loss_hed_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void SigmoidCrossEntropyLossHedLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SigmoidCrossEntropyLossHedLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SigmoidCrossEntropyLossHedLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SigmoidCrossEntropyLossHedLayer<Dtype>::Backward_cpu(
...
#ifdef CPU_ONLY
STUB_GPU_BACKWARD(SigmoidCrossEntropyLossHedLayer, Backward);
#endif

INSTANTIATE_CLASS(SigmoidCrossEntropyLossHedLayer);
REGISTER_LAYER_CLASS(SigmoidCrossEntropyLossHed);
