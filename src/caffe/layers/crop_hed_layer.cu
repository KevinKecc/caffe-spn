...
template <typename Dtype>
void CropHedLayer<Dtype>::crop_copy_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void CropHedLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void CropHedLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(CropHedLayer);
