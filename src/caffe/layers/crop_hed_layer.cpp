...
#include "caffe/layers/crop_hed_layer.hpp"
...
template <typename Dtype>
void CropHedLayer<Dtype>::crop_copy(const vector<Blob<Dtype>*>& bottom,
             const vector<Blob<Dtype>*>& top,
...
template <typename Dtype>
void CropHedLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void CropHedLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(CropHedLayer);
#endif

INSTANTIATE_CLASS(CropHedLayer);
REGISTER_LAYER_CLASS(CropHed);
