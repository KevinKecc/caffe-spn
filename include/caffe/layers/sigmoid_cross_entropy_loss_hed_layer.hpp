#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_HED_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_HED_LAYER_HPP_
...
class SigmoidCrossEntropyLossHedLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossHedLayer(const LayerParameter& param)
