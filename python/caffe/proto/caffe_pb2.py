...
_SOFTPROPOSALPARAMETER_ENGINE = _descriptor.EnumDescriptor(
  name='Engine',
  full_name='caffe.SoftProposalParameter.Engine',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_V1LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFT_PROPOSAL', index=40, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SPATIAL_SUM_OVER_MAP', index=41, number=42,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IMAGE_LABELMAP_DATA', index=42, number=43,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGMOID_CROSS_ENTROPY_LOSS_HED', index=43, number=44,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CROP_HED', index=44, number=45,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='soft_proposal_param', full_name='caffe.LayerParameter.soft_proposal_param', index=58,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_labelmap_data_param', full_name='caffe.LayerParameter.image_labelmap_data_param', index=59,
...
_SOFTPROPOSALPARAMETER = _descriptor.Descriptor(
  name='SoftProposalParameter',
  full_name='caffe.SoftProposalParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='engine', full_name='caffe.SoftProposalParameter.engine', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='factor', full_name='caffe.SoftProposalParameter.factor', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tolerance', full_name='caffe.SoftProposalParameter.tolerance', index=2,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='maxiteration', full_name='caffe.SoftProposalParameter.maxiteration', index=3,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMAGELABELMAPDATAPARAMETER = _descriptor.Descriptor(
  name='ImageLabelmapDataParameter',
  full_name='caffe.ImageLabelmapDataParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='source', full_name='caffe.ImageLabelmapDataParameter.source', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.ImageLabelmapDataParameter.batch_size', index=1,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='rand_skip', full_name='caffe.ImageLabelmapDataParameter.rand_skip', index=2,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='caffe.ImageLabelmapDataParameter.shuffle', index=3,
      number=8, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='new_height', full_name='caffe.ImageLabelmapDataParameter.new_height', index=4,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='new_width', full_name='caffe.ImageLabelmapDataParameter.new_width', index=5,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='is_color', full_name='caffe.ImageLabelmapDataParameter.is_color', index=6,
      number=11, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.ImageLabelmapDataParameter.scale', index=7,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_file', full_name='caffe.ImageLabelmapDataParameter.mean_file', index=8,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_size', full_name='caffe.ImageLabelmapDataParameter.crop_size', index=9,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mirror', full_name='caffe.ImageLabelmapDataParameter.mirror', index=10,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='root_folder', full_name='caffe.ImageLabelmapDataParameter.root_folder', index=11,
      number=12, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_V1LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='soft_proposal_param', full_name='caffe.V1LayerParameter.soft_proposal_param', index=43,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_labelmap_data_param', full_name='caffe.V1LayerParameter.image_labelmap_data_param', index=44,
...
_LAYERPARAMETER.fields_by_name['soft_proposal_param'].message_type = _SOFTPROPOSALPARAMETER
_LAYERPARAMETER.fields_by_name['image_labelmap_data_param'].message_type = _IMAGELABELMAPDATAPARAMETER
_SOFTPROPOSALPARAMETER.fields_by_name['engine'].enum_type = _SOFTPROPOSALPARAMETER_ENGINE
_SOFTPROPOSALPARAMETER_ENGINE.containing_type = _SOFTPROPOSALPARAMETER;
...
_V1LAYERPARAMETER.fields_by_name['soft_proposal_param'].message_type = _SOFTPROPOSALPARAMETER
_V1LAYERPARAMETER.fields_by_name['image_labelmap_data_param'].message_type = _IMAGELABELMAPDATAPARAMETER
...
DESCRIPTOR.message_types_by_name['SoftProposalParameter'] = _SOFTPROPOSALPARAMETER
...
DESCRIPTOR.message_types_by_name['ImageLabelmapDataParameter'] = _IMAGELABELMAPDATAPARAMETER
...
class SoftProposalParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _SOFTPROPOSALPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.SoftProposalParameter)
...
class ImageLabelmapDataParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _IMAGELABELMAPDATAPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.ImageLabelmapDataParameter)
